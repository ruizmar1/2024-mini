...
Skip to content
Using Boston University Mail with screen readers
...
Marissa Ruiz
Attachments
6:33 PM (0 minutes ago)
to me



On Thu, Sep 12, 2024 at 6:30 PM Ryan Flynn <rpflynn@bu.edu> wrote:
"""
...
# IF you want the LED to act like  night light (bright in darkness, dim in brightness), use below values
#max_bright = 21000 
#min_bright = 7600 
